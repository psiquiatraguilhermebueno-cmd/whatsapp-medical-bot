...
class Reminder(db.Model):
    ...
    breathing_exercise_id = db.Column(db.Integer, db.ForeignKey('breathing_exercise.id'), nullable=True)
    ...
    def to_dict(self):
        return {
            ...
            'next_send_date': self.next_send_date.isoformat() if self.next_send_date else None,
